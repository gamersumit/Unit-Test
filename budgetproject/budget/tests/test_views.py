...
class TestViews(TestCase):
    ...
    def test_project_detail_POST_adds_new_expense(self):
        ...
        response = self.client.post(self.detail_url, {'title' : 'expense1', 'amount' : 1000, 'category' : 'development'})
    ...
    def test_project_detail_DELETE_deletes_expense(self):
        ...
        Expense.objects.create(project = self.project1, title = 'expense1', amount = 1000, category = category1)
